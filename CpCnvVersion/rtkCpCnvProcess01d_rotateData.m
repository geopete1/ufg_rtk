function [X_n,Y_n,Z_n,X_s,Y_s,Z_s,X_n_rot,Y_n_rot,X_s_rot,Y_s_rot,...
    ...
    rtkCpCnvProcess01d_rotateData...
    (surveydate,RefFeatDir,Y,X,Z,PX_n,PY_n,PX_s,PY_s,theta_opt_n,theta_opt_s)
%
% Function to rotate a series of dGPS-obtained survey points as well as 
...
%%
disp('Running function rtkCpCnvProcess01d_rotateData.m')
...
IN_n=inpoly([X(:) Y(:)],[NrthBoxPoly_x(:) NrthBoxPoly_y(:)]);
IN_s=inpoly([X(:) Y(:)],[SthBoxPoly_x(:) SthBoxPoly_y(:)]);
