function [Xg_n_rot,Yg_n_rot,Zg_n_rot,Xg_s_rot,Yg_s_rot,Zg_s_rot]=...
    rtkCpCnvProcess01e_buildRasters(surveydate,X_n_rot,Y_n_rot,Z_n,X_s_rot,Y_s_rot,Z_s,...
    PX_n_rot,PY_n_rot,PX_s_rot,PY_s_rot)
%
% Function to build 1m x 1m rotated rasters of the north and south reaches
% of Cape Canaveral KSC coast.  Inputs include the surveydate string, the 
...
%%
disp('Running function rtkCpCnvProcess01e_buildRasters.m')
