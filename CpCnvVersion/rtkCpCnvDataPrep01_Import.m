...
% clean_dir='RTK_Survey_Clean_CPB/';
dateForTitles=datestr(datetime(date_str,'InputFormat','yyMMdd'),'mmm-dd-yyyy');

% Define the path to the DOP and PTS files
path_r13=[genl_path raw_dir surveydatestr '/25413/'];
path_r64=[genl_path raw_dir surveydatestr '/25664/'];
...
print('-dpng','-r600',[genl_path 'FigDumps/' 'KSC_ImportClean_20' date_str '.png'])
...
print('-dpng','-r600',[genl_path 'FigDumps/' 'KSC_ImportMap_20' date_str '.png'])
