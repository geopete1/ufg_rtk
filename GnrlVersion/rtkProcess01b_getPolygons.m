function [PX_n PY_n PX_s PY_s]=rtkProcess01b_getPolygons(surveydate,...
...
%% 
disp('Running function rtkProcess01b_getPolygons.m')
...
IN_n=inpoly([PX(:) PY(:)],[NrthBoxPolyMtnzs_x(:) NrthBoxPolyMtnzs_y(:)]);
IN_s=inpoly([PX(:) PY(:)],[SthBoxPolyMtnzs_x(:) SthBoxPolyMtnzs_y(:)]);
...
plot(NrthBoxPolyMtnzs_x,NrthBoxPolyMtnzs_y,'m','linewidth',2)
plot(SthBoxPolyMtnzs_x,SthBoxPolyMtnzs_y,'g','linewidth',2)
