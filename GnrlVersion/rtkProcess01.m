%% rtkProcess01.m
%
% The main (trunk) code to produce DEMs from RTK-GPS surveys. This code 
% calls several other functions then conducts a bunch of plotting.
%
...
% Generalized to handle Matanzas data, Sept. 2017
%%
function rtkProcess01(surveydate,datadir,RefFeatDir,PcsdDataDir)
% surveydate='110613'; res='05';
disp(surveydate)
tic
%% 1. Convert survey data variable names from DataPrep to Process
[Y X Z East_cl_10cm North_cl_10cm K_10cm]=rtkProcess01a_loadmat(datadir,surveydate);
toc
%% 2. Obtain Bounding Polygons and Break survey data into two regions
[PX_n,PY_n,PX_s,PY_s]=rtkProcess01b_getPolygons(surveydate,...
...
pcolor(Xg_s,Yg_s,Zg_s),shading interp,axis equal,axis tight
